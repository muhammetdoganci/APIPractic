...
public class GMIBank01 extends GMIBankBaseURL {
       /*
    ttp://www.gmibank.com/api/tp-customers end point'ine
    equest gönderin
    ...
    */
    @Test
    public void gmiBank01() throws JsonProcessingException {
        Customer[] customers;
        ...
        //3) Tüm Customer SSN lerini text dosyası olarak kaydedin
        String fileName = "src/test/java/day04/SSNNumber.txt";
        ...
        Assert.assertTrue("SSN ler eslesmedi",actualSSn.containsAll(expectedSSN));
